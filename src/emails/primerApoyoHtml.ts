...
<div style="max-width:560px;margin:0 auto;padding:40px 24px">
  ...
  <div style="background-color:#2d1a08;border-radius:20px;border:1px solid rgba(232,168,76,0.25);padding:40px 32px">
    ...
    <div style="text-align:center;margin-bottom:8px">
      <a href="https://deseocomer.com/concursos" style="background-color:#e8a84c;color:#1a0e05;font-size:14px;font-weight:bold;letter-spacing:0.1em;text-transform:uppercase;text-decoration:none;padding:16px 40px;border-radius:12px;display:inline-block">Ver mi concurso →</a>
    </div>
  </div>
