...
const localesMock = [
  { id: 1, nombre: "Pizza Napoli",          categorias: ["Pizza"],    barrio: "Providencia",     emoji: "🍕", rating: 0, precio: "", isOpen: true, descripcion: "La mejor pizza napolitana de Santiago, horno de leña importado de Italia.",       imagenUrl: "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=600", logoUrl: null as string | null },
  { id: 2, nombre: "Sushi Oasis",           categorias: ["Sushi"],     barrio: "Las Condes",      emoji: "🍣", rating: 0, precio: "", isOpen: true, descripcion: "Omakase y rolls creativos con ingredientes del Pacífico.",                          imagenUrl: "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=600", logoUrl: null as string | null },
