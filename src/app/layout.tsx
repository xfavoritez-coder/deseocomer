      ...
      <head>
        <script dangerouslySetInnerHTML={{ __html: `(function(){
          ...
          var T={
            ...
            dia:{bg:"#1e1400",bg2:"rgba(32,20,2,0.95)",text:"#fff8e0",muted:"#b09040",accent:"#e8a020",border:"rgba(232,160,32,0.25)",title:"#e8a020",link:"#1aa098",label:"#706018",ctext:"#cca858"},
