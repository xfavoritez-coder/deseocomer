    ...
    <main style={{ background: "var(--bg-primary)", minHeight: "100vh" }}>
      ...
      <section className="dc-lp-hero">
        ...
        <div style={{ position: "relative", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "var(--font-lato)", fontSize: "clamp(1rem, 2.5vw, 1.15rem)", color: "var(--text-primary)", fontWeight: 400, maxWidth: "520px", margin: "0 auto", lineHeight: 1.8 }}>Los mejores locales gastronómicos de Chile.</p>
        </div>
      </section>
