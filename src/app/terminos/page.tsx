    ...
    <main style={{ background: "#0a0812", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: "800px", margin: "0 auto", padding: "120px 20px 80px" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "0.5px solid rgba(232,168,76,0.15)", borderRadius: "20px", padding: "clamp(24px,5vw,40px)" }}>
          ...
          <p style={SUB}><strong style={{ color: "#e8a84c" }}>3.1 Activación y verificación:</strong> Las cuentas tienen dos niveles. La <strong style={{ color: "#f5d080" }}>activación</strong> se realiza confirmando tu email y te permite navegar, guardar favoritos y explorar la plataforma. La <strong style={{ color: "#f5d080" }}>verificación</strong> requiere confirmar tu número de celular mediante un código SMS, y es necesaria para participar en concursos y para que se acrediten los puntos del sistema de referidos. Este proceso protege la integridad de los concursos y garantiza que cada participante sea una persona real.</p>
          ...
          <p style={SUB}><strong style={{ color: "#e8a84c" }}>5.1 Elegibilidad:</strong> Para participar en concursos el usuario debe contar con una cuenta activada (email confirmado) y verificada (celular confirmado mediante SMS). Los puntos de referidos solo se acreditan a ambas partes una vez que el usuario referido haya completado la verificación de celular.</p>
          ...
          <p style={SUB}><strong style={{ color: "#e8a84c" }}>6.1 Modalidades de concurso:</strong> DeseoComer ofrece dos modalidades de concurso. En la modalidad &ldquo;Méritos&rdquo;, gana el participante con más puntos al cierre. En la modalidad &ldquo;Sorteo&rdquo;, se realiza un sorteo ponderado donde cada punto acumulado equivale a un boleto — a mayor cantidad de boletos, mayor probabilidad de ser seleccionado ganador. El resultado del sorteo es definitivo e inapelable.</p>
          <p style={SUB}><strong style={{ color: "#e8a84c" }}>6.2 Selección del ganador:</strong> El ganador es determinado automáticamente por el sistema según la modalidad del concurso (méritos o sorteo), sujeto a verificación antifraude.</p>
