        ...
        {sharePrompt && (
          <div style={{ background: "linear-gradient(135deg, rgba(232,168,76,0.12), rgba(232,168,76,0.04))", border: "1px solid rgba(232,168,76,0.35)", borderRadius: "14px", padding: "20px", marginBottom: "20px", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              <a href={`/story/${detalle.slug || detalle.id}`} target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", padding: "11px", background: "rgba(225,48,108,0.08)", border: "1px solid rgba(225,48,108,0.3)", borderRadius: "10px", fontFamily: "var(--font-cinzel)", fontSize: "0.78rem", fontWeight: 700, color: "#e1306c", textDecoration: "none", textTransform: "uppercase", letterSpacing: "0.06em" }}>
    ...
    <div style={{ position: "sticky", top: 0, zIndex: 10, background: "var(--bg-primary)", paddingBottom: "8px", paddingTop: "4px", width: "100%", boxSizing: "border-box", marginBottom: "16px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          ...
          <button onClick={() => { setStep(0); setWizard(true); }} style={{ background: "none", border: "none", padding: 0, cursor: "pointer", fontFamily: "var(--font-lato)", fontSize: "0.75rem", color: "rgba(240,234,214,0.35)", marginTop: "2px", textDecoration: "underline" }}>¿Cómo funcionan?</button>
        </div>
