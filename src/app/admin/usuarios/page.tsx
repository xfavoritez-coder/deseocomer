        ...
        <div style={cardS}>
          ...
          <div style={{ marginBottom: "10px" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
              {["Pizza", "Sushi", "Hamburguesa", "Mexicano", "Vegano", "Vegetariano", "Saludable", "Pastas", "Pollo", "Mariscos", "Carnes / Parrilla", "Árabe", "Peruano", "India", "Coreano", "Mediterráneo", "Thai", "Ramen", "Fusión", "Sin gluten", "Café", "Postres", "Brunch", "Chifa", "Empanadas", "Poke Bowl", "Sandwich", "Jugos y Smoothies"].map(c => {
