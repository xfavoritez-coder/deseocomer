        ...
        <>
          ...
          <div style={PANEL}>
            ...
            <div style={{ marginTop: "24px", display: "flex", flexDirection: "column", gap: "10px" }}>
              ...
              <a href={`/story/${sel.slug || sel.id}`} target="_blank" rel="noopener" style={{ display: "block", textAlign: "center", fontFamily: "Georgia", fontSize: "0.82rem", padding: "10px", borderRadius: "8px", border: "1px solid rgba(225,48,108,0.3)", color: "#E1306C", textDecoration: "none" }}>📸 Compartir por Instagram</a>
