    ...
    <div>
      ...
      {!editMode && !passMode && !rejectMode && !deleteConfirm && (
        <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginTop: "16px" }}>
          ...
          <a href={`/locales/${sel.slug || sel.id}?tab=Concursos`} target="_blank" rel="noopener" style={{ ...btnOutlineS, textDecoration: "none", textAlign: "center", color: "#e8a84c", borderColor: "rgba(232,168,76,0.4)" }}>🏆 Ver concursos del local</a>
