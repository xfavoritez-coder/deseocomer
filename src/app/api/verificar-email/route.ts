              ...
              if (referidorNivel2Id) {
                ...
                if (nivel2Part && (nivel2Part.puntosNivel2 ?? 0) < 20) {
                  if (telVerificado) {
                    ...
                    // Email + notificación red — una sola vez en la vida
                    ...
                    if (n2User && !n2User.emailNivel2Enviado) {
                      prisma.notificacion.create({ data: { usuarioId: referidorNivel2Id!, tipo: "red_crecio", mensaje: `🌐 ¡Formaste tu red! ${refDirectoNombre ?? "tu referido"} trajo a alguien y tú ganaste +2 pts. Mira tu red en tu perfil`, datos: { link: "/perfil?tab=concursos" } } }).catch(() => {});
